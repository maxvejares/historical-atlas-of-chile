...
window._familyMetadata = {
    ...
    agriculture_province_1924: { display_name: "Agriculture province 1924 (papas, trigo_blanco)", geo_levels: ["province"], n_member_variables: 10, n_observations: 800, per_capita_default: "user_choice", source_type: "anuario", units: "physical_quantity", valid_years_pattern: "1924-1974", zeros_are_real: "sometimes" },
    ...
    budget_operating_subnational: { display_name: "Budgeted operating expenses (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 187, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1890-1894", zeros_are_real: "never" },
    budget_personnel_subnational: { display_name: "Budgeted personnel posts (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 187, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1890-1894", zeros_are_real: "never" },
    budget_salaries_subnational: { display_name: "Budgeted salaries (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 187, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1890-1894", zeros_are_real: "never" },
    ...
    government_accounts: { display_name: "Government accounts (cuenta_gobierno_*)", geo_levels: ["national"], n_member_variables: 182, n_observations: 780, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1960-1970", zeros_are_real: "sometimes" },
    hospital_statistics: { display_name: "Hospital statistics (admissions, beds, deaths, expenses, subsidies)", geo_levels: ["city", "department", "national", "province"], n_member_variables: 86, n_observations: 4077, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1840-1940", zeros_are_real: "sometimes" },
    ...
    marriages_age_cohort: { display_name: "Marriages by age cohort", geo_levels: ["department", "national", "province"], n_member_variables: 31, n_observations: 850, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1858-1973", zeros_are_real: "sometimes" },
    ...
    mortality_categorical: { display_name: "Mortality by cause / category", geo_levels: ["department", "national", "province"], n_member_variables: 23, n_observations: 351, per_capita_default: "default_raw", source_type: "anuario", units: "rate", valid_years_pattern: "1849-1975", zeros_are_real: "sometimes" },
    mortality_natality_long_series: { display_name: "Mortality / natality long series (lowercase)", geo_levels: ["department", "national", "province"], n_member_variables: 121, n_observations: 5308, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1849-1983", zeros_are_real: "never" },
    ...
    occupations_profesion_subnational: { display_name: "Census detailed occupations (profesion_*)", geo_levels: ["department", "national", "province"], n_member_variables: 2178, n_observations: 17418, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1875-1875", zeros_are_real: "never" },
    ...
    prisons: { display_name: "Prison / corrections (reos, presidios, correccionales)", geo_levels: ["city", "national", "province"], n_member_variables: 98, n_observations: 1559, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1869-1935", zeros_are_real: "sometimes" },
    ...
    total_population_subnational: { display_name: "Total population (subnational)", geo_levels: ["commune", "department", "national", "province", "religion"], n_member_variables: 6, n_observations: 3540, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1835-1980", zeros_are_real: "never" },
