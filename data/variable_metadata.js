...
window._variableToFamily = {
    ...
    matrimonios_total: "mortality_natality_long_series",
...
window._familyMetadata = {
    ...
    age_specific_fertility: { display_name: "Age-specific fertility rates", geo_levels: ["national"], n_member_variables: 27, n_observations: 123, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1960-1970", zeros_are_real: "never" },
    ...
    agricultural_census_1930_commune: { display_name: "1930 Agricultural Census, commune level (size classes)", geo_levels: ["province"], n_member_variables: 16, n_observations: 3081, per_capita_default: "user_choice", source_type: "census", units: "count", valid_years_pattern: "1930-1930", zeros_are_real: "sometimes" },
    agriculture_dept_1889: { display_name: "Agriculture by department, 1889 (siembra / cosecha)", geo_levels: ["department", "province"], n_member_variables: 40, n_observations: 393, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1889-1889", zeros_are_real: "sometimes" },
    agriculture_province_1924: { display_name: "Agriculture province 1924 (papas, trigo_blanco)", geo_levels: ["province"], n_member_variables: 10, n_observations: 784, per_capita_default: "user_choice", source_type: "anuario", units: "physical_quantity", valid_years_pattern: "1924-1974", zeros_are_real: "sometimes" },
    agriculture_province_1935: { display_name: "Agriculture/livestock province 1935", geo_levels: ["department", "national", "province"], n_member_variables: 29, n_observations: 1057, per_capita_default: "user_choice", source_type: "anuario", units: "physical_quantity", valid_years_pattern: "1855-1935", zeros_are_real: "sometimes" },
    ...
    auto_pop_censal_yyyy: { display_name: "Auto Pop Censal Yyyy", geo_levels: ["department", "national", "province"], n_member_variables: 6, n_observations: 1170, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1865-1920", zeros_are_real: "never" },
    auto_pop_censal_yyyy_dept: { display_name: "Auto Pop Censal Yyyy Dept", geo_levels: ["department"], n_member_variables: 6, n_observations: 11, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1865-1920", zeros_are_real: "never" },
    ...
    bankruptcies_subnational: { display_name: "Bankruptcies declared by province", geo_levels: ["national", "province"], n_member_variables: 1, n_observations: 118, per_capita_default: "default_raw", source_type: "anuario", units: "count", valid_years_pattern: "1933-1935", zeros_are_real: "always" },
    ...
    budget: { display_name: "Annual budget (presupuestos)", geo_levels: ["national"], n_member_variables: 4, n_observations: 81, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1940", zeros_are_real: "never" },
    budget_operating_subnational: { display_name: "Budgeted operating expenses (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 412, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1890-1896", zeros_are_real: "never" },
    budget_personnel_subnational: { display_name: "Budgeted personnel posts (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 412, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1890-1896", zeros_are_real: "never" },
    budget_salaries_subnational: { display_name: "Budgeted salaries (Lei de Presupuestos, subnational)", geo_levels: ["city", "department", "province"], n_member_variables: 3, n_observations: 412, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1890-1896", zeros_are_real: "never" },
    ...
    church_records_baptisms: { display_name: "Baptisms (church records)", geo_levels: ["department"], n_member_variables: 2, n_observations: 616, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1865-1880", zeros_are_real: "never" },
    ...
    civic_corps_finance: { display_name: "Guardia Nacional civic corps finances (M113)", geo_levels: ["city"], n_member_variables: 3, n_observations: 468, per_capita_default: "default_raw", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1889-1889", zeros_are_real: "sometimes" },
    clergy_and_church_estate: { display_name: "Clergy and church estate (clero, culto, dioceses, parishes)", geo_levels: ["national"], n_member_variables: 27, n_observations: 81, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1900-1917", zeros_are_real: "always" },
    commune_1935_indicators: { display_name: "Commune indicators, 1935 (enfermos, salaries, rural)", geo_levels: ["commune"], n_member_variables: 3, n_observations: 859, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1935-1935", zeros_are_real: "sometimes" },
    ...
    crop_production_series: { display_name: "Field crop production (area, output, yield, value)", geo_levels: ["province"], n_member_variables: 56, n_observations: 4743, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1965-1974", zeros_are_real: "sometimes" },
    customs_and_trade_aggregates: { display_name: "Customs and trade aggregates (general, special, by sea, by land)", geo_levels: ["national", "port"], n_member_variables: 15, n_observations: 546, per_capita_default: "default_raw", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1852-1900", zeros_are_real: "sometimes" },
    ...
    dairy_production: { display_name: "Dairy production (milk delivered to plants, value)", geo_levels: ["province"], n_member_variables: 2, n_observations: 160, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1973-1974", zeros_are_real: "sometimes" },
    death_certification_subnational: { display_name: "Deaths by certification (medical vs witness)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    demographic_indices_1976: { display_name: "Demographic indices (dependency, masculinity, ageing)", geo_levels: ["national", "region"], n_member_variables: 3, n_observations: 30, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1976-1976", zeros_are_real: "never" },
    disabilities_subnational: { display_name: "Census disabilities (imposibilitados: ciegos, sordomudos, tullidos)", geo_levels: ["department", "national", "province"], n_member_variables: 115, n_observations: 606, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1854-1895", zeros_are_real: "always" },
    dlw_commodity_production: { display_name: "Commodity production volumes (national, DLW long series)", geo_levels: ["department", "national", "province"], n_member_variables: 3, n_observations: 12, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "physical_quantity", valid_years_pattern: "1878-1923", zeros_are_real: "sometimes" },
    dlw_demographics_capitalized: { display_name: "DLW national demographic series (capitalized)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "rate", valid_years_pattern: "nan", zeros_are_real: "never" },
    dlw_exports_categorical_lower: { display_name: "Exports by sector (DLW lowercase, mill_usd / pct)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_usd", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    dlw_fiscal_capitalized: { display_name: "DLW fiscal series (capitalized: Trib_, Ing_, G_, Gastos_, Gasto_)", geo_levels: ["national"], n_member_variables: 1, n_observations: 25, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1883-1982", zeros_are_real: "sometimes" },
    dlw_fiscal_share_series: { display_name: "Diaz-Lüders-Wagner fiscal share series (national)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "pct", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    dlw_gdp_series: { display_name: "Diaz-Lüders-Wagner GDP series (national, 1810-1995)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "nan", zeros_are_real: "never" },
    dlw_imports_categorical_lower: { display_name: "Imports by category (DLW lowercase, mill_usd / pct)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_usd", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    dlw_investment_capitalized: { display_name: "DLW investment / capital formation (capitalized)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    dlw_labor_capitalized: { display_name: "DLW labor force series (capitalized)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_pc", source_type: "diaz_luders_wagner", units: "count", valid_years_pattern: "nan", zeros_are_real: "never" },
    dlw_labor_force_national: { display_name: "Diaz-Lüders-Wagner labor force shares (national)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "pct", valid_years_pattern: "nan", zeros_are_real: "never" },
    dlw_monetary_capitalized: { display_name: "DLW monetary aggregates and price indices (capitalized)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "index", valid_years_pattern: "nan", zeros_are_real: "never" },
    dlw_pib_capitalized: { display_name: "DLW national accounts: PIB nominal/real/sectoral (capitalized)", geo_levels: ["national"], n_member_variables: 1, n_observations: 24, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1960-1983", zeros_are_real: "never" },
    dlw_trade_series: { display_name: "Diaz-Lüders-Wagner trade series (national, 1810-1995)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    dwelling_services: { display_name: "Dwelling services (piped water, sewerage, electric light)", geo_levels: ["commune"], n_member_variables: 8, n_observations: 5360, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1992-1992", zeros_are_real: "always" },
    dwelling_stock: { display_name: "Dwelling stock (viviendas, hogares)", geo_levels: ["commune"], n_member_variables: 7, n_observations: 4690, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1992-1992", zeros_are_real: "never" },
    dwelling_tenure: { display_name: "Dwelling tenure (owned, rented, other)", geo_levels: ["commune"], n_member_variables: 3, n_observations: 2010, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1992-1992", zeros_are_real: "always" },
    economic_activity_provincial: { display_name: "Provincial economic activity panel (1952-1970, holding pen)", geo_levels: ["national", "province"], n_member_variables: 12, n_observations: 355, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1854-1983", zeros_are_real: "sometimes" },
    economically_active_population: { display_name: "Economically active population (PEA)", geo_levels: ["national"], n_member_variables: 24, n_observations: 64, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1952-1970", zeros_are_real: "never" },
    education_enrollment_matricula: { display_name: "Education enrollment (matrícula, anuario series)", geo_levels: ["national", "province"], n_member_variables: 14, n_observations: 475, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1891-1914", zeros_are_real: "never" },
    education_finance: { display_name: "Education finance (school expenditure, education budget)", geo_levels: ["national", "province"], n_member_variables: 3, n_observations: 170, per_capita_default: "default_pc", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1850-1920", zeros_are_real: "never" },
    ...
    electoral_registration: { display_name: "Electoral registration (inscritos, inscripciones, incluidos / excluidos)", geo_levels: ["province"], n_member_variables: 6, n_observations: 230, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1916-1917", zeros_are_real: "always" },
    electoral_subnational: { display_name: "Electoral panel (calificados, inscriptos, sufragantes)", geo_levels: ["department", "national", "province"], n_member_variables: 19, n_observations: 3033, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1862-1935", zeros_are_real: "never" },
    employment_quarterly_sectoral: { display_name: "Employment by sector (quarterly, 1957-)", geo_levels: ["national"], n_member_variables: 532, n_observations: 532, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1956-1978", zeros_are_real: "never" },
    epidemic_disease_subnational: { display_name: "Epidemic disease (smallpox deaths, cholera municipal aid)", geo_levels: ["city", "department", "national"], n_member_variables: 2, n_observations: 625, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1886-1894", zeros_are_real: "always" },
    ethnicity_indigenous: { display_name: "Ethnicity / indigenous population (Mapuche, Mestizo, Indios)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    ...
    expenditure_per_capita: { display_name: "Expenditure per capita (derived)", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "nan", zeros_are_real: "never" },
    ...
    fiscal_expenditure_categorical: { display_name: "Fiscal expenditure (categorical)", geo_levels: ["department", "national", "province"], n_member_variables: 57, n_observations: 1921, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1817-1988", zeros_are_real: "sometimes" },
    fiscal_expenditure_ramos: { display_name: "Fiscal expenditure by ramo (gasto_*, ministry lines, shares)", geo_levels: ["national"], n_member_variables: 85, n_observations: 2979, per_capita_default: "default_pc", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1914", zeros_are_real: "sometimes" },
    fiscal_revenue_categorical: { display_name: "Fiscal revenue (categorical)", geo_levels: ["department", "national"], n_member_variables: 22, n_observations: 664, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1817-1924", zeros_are_real: "sometimes" },
    fiscal_revenue_ramos: { display_name: "Fiscal revenue by ramo (renta_*, entrada_*, revenue_*)", geo_levels: ["department", "national", "port"], n_member_variables: 101, n_observations: 5626, per_capita_default: "default_pc", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1831-1924", zeros_are_real: "sometimes" },
    foreigners_aggregates: { display_name: "Foreigners by nationality and aggregate (census cross-sections)", geo_levels: ["department", "macro_region", "national", "province"], n_member_variables: 744, n_observations: 4542, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1854-1920", zeros_are_real: "always" },
    ...
    fruit_production_series: { display_name: "Fruit and nut production (area, output, yield, value)", geo_levels: ["province"], n_member_variables: 56, n_observations: 848, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1974-1974", zeros_are_real: "sometimes" },
    ...
    geo_metadata_extended: { display_name: "Geographic metadata extended (lat, lon, capital, surface)", geo_levels: ["department", "national", "province"], n_member_variables: 4, n_observations: 250, per_capita_default: "not_applicable", source_type: "compiled", units: "categorical", valid_years_pattern: "1854-1952", zeros_are_real: "always" },
    government_accounts: { display_name: "Government accounts (cuenta_gobierno_*)", geo_levels: ["national"], n_member_variables: 182, n_observations: 778, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1960-1970", zeros_are_real: "sometimes" },
    hospital_statistics: { display_name: "Hospital statistics (admissions, beds, deaths, expenses, subsidies)", geo_levels: ["city", "department", "national", "province"], n_member_variables: 97, n_observations: 5124, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1840-1940", zeros_are_real: "sometimes" },
    household_consumption_indicators: { display_name: "Household consumption indicators (calidad_vida_*, equip_hogar_*, pct_hogares_*)", geo_levels: ["national"], n_member_variables: 86, n_observations: 94, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1970-1982", zeros_are_real: "never" },
    ...
    housing_surface: { display_name: "Building and housing surface (1952-1999)", geo_levels: ["national"], n_member_variables: 12, n_observations: 320, per_capita_default: "default_pc", source_type: "compiled", units: "physical_quantity", valid_years_pattern: "1952-2000", zeros_are_real: "sometimes" },
    industrial_machinery: { display_name: "Industrial machinery (steam engines, horsepower, coal)", geo_levels: ["province"], n_member_variables: 4, n_observations: 74, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1858-1858", zeros_are_real: "always" },
    infant_child_mortality: { display_name: "Infant and child mortality (child deaths, legitimacy permil)", geo_levels: ["city", "national", "province"], n_member_variables: 12, n_observations: 586, per_capita_default: "default_raw", source_type: "anuario", units: "count", valid_years_pattern: "1827-1925", zeros_are_real: "never" },
    justice_caseload: { display_name: "Judicial caseload (causas ingresadas / falladas by court)", geo_levels: ["national", "province"], n_member_variables: 42, n_observations: 450, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1857-1908", zeros_are_real: "always" },
    ...
    labor_disputes: { display_name: "Labor disputes (huelgas, trabajadores afectados)", geo_levels: ["national"], n_member_variables: 4, n_observations: 4, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1955-1955", zeros_are_real: "sometimes" },
    labor_force_participation_extended: { display_name: "Labor force participation extended (ocupacion, pct_poblacion_12plus, etc.)", geo_levels: ["national"], n_member_variables: 42, n_observations: 149, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1853-1976", zeros_are_real: "sometimes" },
    labor_force_quarterly_sectoral: { display_name: "Labor force by sector (quarterly, 1957-)", geo_levels: ["national"], n_member_variables: 1085, n_observations: 1091, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1940-1978", zeros_are_real: "never" },
    ...
    land_use_cultivos: { display_name: "Land use by cultivation class (sementeras, praderas, arboricultura)", geo_levels: ["province"], n_member_variables: 13, n_observations: 929, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1924-1925", zeros_are_real: "sometimes" },
    landholding_avaluo: { display_name: "Landholding: avaluo and Rol", geo_levels: ["constituency", "department"], n_member_variables: 23, n_observations: 1384, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1830-1970", zeros_are_real: "never" },
    landholding_counts: { display_name: "Landholding counts and imputed rents (fundos, propietarios)", geo_levels: ["commune", "department", "national", "province"], n_member_variables: 15, n_observations: 1090, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1852-1935", zeros_are_real: "never" },
    ...
    laws_enacted_by_ministry: { display_name: "Laws enacted by ministry (leyes_*)", geo_levels: ["national"], n_member_variables: 10, n_observations: 331, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1893-1917", zeros_are_real: "always" },
    ...
    life_expectancy_provincial: { display_name: "Life expectancy provincial (esperanza_vida_*)", geo_levels: ["province", "region"], n_member_variables: 7, n_observations: 21, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1967-1972", zeros_are_real: "never" },
    literacy_counts_subnational: { display_name: "Literacy counts and rates (saben leer / escribir, alfabetos)", geo_levels: ["national", "province"], n_member_variables: 39, n_observations: 695, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1854-1952", zeros_are_real: "never" },
    literacy_subnational: { display_name: "Literacy (subnational, by census year)", geo_levels: ["department", "national", "province"], n_member_variables: 27, n_observations: 647, per_capita_default: "default_raw", source_type: "census", units: "rate", valid_years_pattern: "1854-1970", zeros_are_real: "never" },
    livestock_subnational: { display_name: "Livestock stock and slaughter (cabezas)", geo_levels: ["province"], n_member_variables: 5, n_observations: 1700, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1965-1974", zeros_are_real: "sometimes" },
    macroeconomic_indicators: { display_name: "Macroeconomic indicators (PIB growth, employment, inflation, savings)", geo_levels: ["national"], n_member_variables: 14, n_observations: 28, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1989-1990", zeros_are_real: "sometimes" },
    ...
    marital_status_counts: { display_name: "Marital status counts (solteros, casados, viudos)", geo_levels: ["national", "province"], n_member_variables: 17, n_observations: 346, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1813-1895", zeros_are_real: "never" },
    ...
    marriages_age_cohort: { display_name: "Marriages by age cohort", geo_levels: ["national"], n_member_variables: 15, n_observations: 147, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1964-1973", zeros_are_real: "sometimes" },
    meteorology_rainfall: { display_name: "Rainfall (annual mm, rain days)", geo_levels: ["city"], n_member_variables: 3, n_observations: 326, per_capita_default: "default_raw", source_type: "anuario", units: "count", valid_years_pattern: "1866-1909", zeros_are_real: "always" },
    migration_internal: { display_name: "Migration (internal / regional, net rates and shares)", geo_levels: ["national", "province", "region"], n_member_variables: 9, n_observations: 123, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1878-1982", zeros_are_real: "sometimes" },
    ...
    mills_subnational: { display_name: "Flour mills (molinos, piedras)", geo_levels: ["province"], n_member_variables: 2, n_observations: 40, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1858-1858", zeros_are_real: "always" },
    ...
    mining_production_pesos_oro: { display_name: "Mining production (pesos oro de 18 peniques, 1918-1923)", geo_levels: ["national"], n_member_variables: 4, n_observations: 44, per_capita_default: "user_choice", source_type: "anuario", units: "currency_pesos_oro_18d", valid_years_pattern: "1918-1923", zeros_are_real: "sometimes" },
    ...
    mortality_categorical: { display_name: "Mortality by cause / category", geo_levels: ["national", "province"], n_member_variables: 22, n_observations: 109, per_capita_default: "default_raw", source_type: "anuario", units: "rate", valid_years_pattern: "1849-1975", zeros_are_real: "sometimes" },
    mortality_natality_long_series: { display_name: "Mortality / natality long series (lowercase)", geo_levels: ["city", "commune", "department", "national", "province"], n_member_variables: 141, n_observations: 44228, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1849-1983", zeros_are_real: "never" },
    municipal_finance: { display_name: "Municipal finance (revenue, expenditure, share)", geo_levels: ["city", "commune", "department", "national", "province"], n_member_variables: 62, n_observations: 13883, per_capita_default: "user_choice", source_type: "sinopsis", units: "currency_pesos", valid_years_pattern: "1861-1935", zeros_are_real: "sometimes" },
    natality_categorical: { display_name: "Natality / birth rate categorical", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "anuario", units: "rate", valid_years_pattern: "nan", zeros_are_real: "never" },
    ...
    national_balance_sheet: { display_name: "National balance sheet (assets, liabilities, currency in circulation, minting)", geo_levels: ["national"], n_member_variables: 15, n_observations: 690, per_capita_default: "default_raw", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1871-1924", zeros_are_real: "sometimes" },
    naval_registration: { display_name: "Naval registration (inscritos en registros navales)", geo_levels: ["national"], n_member_variables: 1, n_observations: 8, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1913-1917", zeros_are_real: "always" },
    net_migration_subnational: { display_name: "Net migration (intercensal counts and rates)", geo_levels: ["national", "province"], n_member_variables: 5, n_observations: 342, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1865-1970", zeros_are_real: "sometimes" },
    ...
    occupations_profesion_subnational: { display_name: "Census detailed occupations (profesion_*)", geo_levels: ["department", "national", "province"], n_member_variables: 3479, n_observations: 20765, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1865-1895", zeros_are_real: "never" },
    ...
    patentes_fiscales: { display_name: "Patentes fiscales (business licences: count, value, class)", geo_levels: ["department", "national", "province"], n_member_variables: 9, n_observations: 6374, per_capita_default: "user_choice", source_type: "anuario", units: "count", valid_years_pattern: "1852-1880", zeros_are_real: "sometimes" },
    ...
    police_subnational_extended: { display_name: "Police force and police spending", geo_levels: ["commune", "department"], n_member_variables: 4, n_observations: 284, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1862-1935", zeros_are_real: "always" },
    population_counts_misc: { display_name: "Population counts (misc. subnational and national readings)", geo_levels: ["city", "department", "macro_region", "national", "province", "province_or_dept", "territory"], n_member_variables: 91, n_observations: 2407, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1813-1982", zeros_are_real: "never" },
    ...
    population_growth: { display_name: "Population growth", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    population_subset_demographic: { display_name: "Population subsets (age, sex, ethnicity)", geo_levels: ["national"], n_member_variables: 30, n_observations: 30, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1952-1952", zeros_are_real: "never" },
    ...
    postal_service_extended: { display_name: "Postal service (correspondence, money orders, offices)", geo_levels: ["city", "national", "province"], n_member_variables: 8, n_observations: 350, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1855-1874", zeros_are_real: "always" },
    postal_volume: { display_name: "Postal volume (cartas, impresos, oficios)", geo_levels: ["city", "department", "national", "province"], n_member_variables: 95, n_observations: 3293, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1831-1935", zeros_are_real: "sometimes" },
    primary_school_enrollment_subnational: { display_name: "Primary school enrollment and attendance (escuelas primarias)", geo_levels: ["department", "national", "province"], n_member_variables: 67, n_observations: 3070, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1853-1920", zeros_are_real: "never" },
    prisons: { display_name: "Prison / corrections (reos, presidios, correccionales)", geo_levels: ["city", "department", "national", "province"], n_member_variables: 102, n_observations: 1571, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1869-1935", zeros_are_real: "sometimes" },
    ...
    public_debt: { display_name: "Public debt (internal, external, total)", geo_levels: ["department", "national"], n_member_variables: 85, n_observations: 2392, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1822-1983", zeros_are_real: "sometimes" },
    ...
    railway_network_extended: { display_name: "Railway network (km, capital, assets)", geo_levels: ["national", "province"], n_member_variables: 6, n_observations: 188, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1860-1905", zeros_are_real: "always" },
    ...
    real_income_sectoral: { display_name: "Real income by sector", geo_levels: ["national"], n_member_variables: 11, n_observations: 154, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos_1995", valid_years_pattern: "1940-1983", zeros_are_real: "never" },
    religion_subnational: { display_name: "Religion subnational (Catholic, Protestant, Evangelical, Jewish, etc.)", geo_levels: ["national", "province"], n_member_variables: 21, n_observations: 297, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1920-1970", zeros_are_real: "sometimes" },
    roads_and_waterways: { display_name: "Roads, bridges and navigable rivers (public works)", geo_levels: ["national", "province"], n_member_variables: 12, n_observations: 102, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1860-1917", zeros_are_real: "always" },
    rural_urban_counts_subnational: { display_name: "Rural population count and share", geo_levels: ["commune", "department"], n_member_variables: 2, n_observations: 716, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1865-1935", zeros_are_real: "never" },
    rural_urban_share_long_series: { display_name: "Rural/urban population share long series", geo_levels: ["macro_region", "national", "province"], n_member_variables: 14, n_observations: 1811, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1835-2000", zeros_are_real: "never" },
    ...
    schools_count_public_private: { display_name: "School counts by funding type (fiscales, municipales, particulares)", geo_levels: ["province"], n_member_variables: 18, n_observations: 825, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1853-1875", zeros_are_real: "always" },
    ...
    secondary_education_panel: { display_name: "Secondary education panel (students, schools by funder type and sex)", geo_levels: ["national"], n_member_variables: 18, n_observations: 18, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1900-1900", zeros_are_real: "never" },
    secondary_school_enrollment_subnational: { display_name: "Secondary school enrollment (liceos, colegios: matricula / asistencia)", geo_levels: ["city", "national", "province"], n_member_variables: 39, n_observations: 3218, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1853-1909", zeros_are_real: "never" },
    shipping_navigation: { display_name: "Shipping and navigation (buques, tonelaje, national share)", geo_levels: ["national", "port"], n_member_variables: 8, n_observations: 560, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1833-1922", zeros_are_real: "sometimes" },
    social_spending: { display_name: "Government social spending (gasto_social_*, gasto_real, etc.)", geo_levels: ["national", "province"], n_member_variables: 17, n_observations: 160, per_capita_default: "default_pc", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1842-2000", zeros_are_real: "sometimes" },
    ...
    state_officials_named: { display_name: "Named state officials (governor, intendant, judge, postal)", geo_levels: ["department"], n_member_variables: 5, n_observations: 929, per_capita_default: "not_applicable", source_type: "memoria", units: "count", valid_years_pattern: "1855-1908", zeros_are_real: "never" },
    state_owned_enterprises: { display_name: "State-owned enterprise share of sector", geo_levels: ["national"], n_member_variables: 7, n_observations: 13, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1965-1972", zeros_are_real: "sometimes" },
    subnational_population_lowercase: { display_name: "Subnational population (lowercase Spanish: poblacion_*, hombres, mujeres)", geo_levels: ["commune", "department", "national", "nationality", "province", "religion"], n_member_variables: 150, n_observations: 7786, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1822-2000", zeros_are_real: "never" },
    subnational_population_titled: { display_name: "Subnational population, Spanish title-case columns", geo_levels: ["department", "national", "province"], n_member_variables: 43, n_observations: 1255, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1835-1983", zeros_are_real: "never" },
    tariff_rates: { display_name: "Tariff rates", geo_levels: ["nan"], n_member_variables: 0, n_observations: 0, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    tax_landholding: { display_name: "Land tax: contribución, arrears, delinquency, compliance", geo_levels: ["department", "national", "province"], n_member_variables: 7, n_observations: 946, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1855-1970", zeros_are_real: "sometimes" },
    telegram_volume: { display_name: "Telegram volume (interior, exterior, total)", geo_levels: ["national"], n_member_variables: 17, n_observations: 68, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1916-1917", zeros_are_real: "always" },
    telegraph_network: { display_name: "Telegraph network (offices, staff, apparatus, lines, assets)", geo_levels: ["city", "national"], n_member_variables: 42, n_observations: 2400, per_capita_default: "default_raw", source_type: "memoria", units: "count", valid_years_pattern: "1888-1900", zeros_are_real: "always" },
    total_population_subnational: { display_name: "Total population (subnational)", geo_levels: ["commune", "department", "national", "province", "religion"], n_member_variables: 36, n_observations: 3694, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1835-1980", zeros_are_real: "never" },
    trade_exports: { display_name: "Exports (trade)", geo_levels: ["national"], n_member_variables: 50, n_observations: 567, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1844-1924", zeros_are_real: "sometimes" },
    trade_imports: { display_name: "Imports (trade)", geo_levels: ["national"], n_member_variables: 21, n_observations: 790, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1844-1930", zeros_are_real: "sometimes" },
    trade_total_categorical: { display_name: "Total trade and trade categories", geo_levels: ["national", "port"], n_member_variables: 32, n_observations: 727, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1844-1914", zeros_are_real: "sometimes" },
    transport_1935_province: { display_name: "Transport 1935 province (vehicles, road km)", geo_levels: ["national", "province"], n_member_variables: 14, n_observations: 525, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1887-1935", zeros_are_real: "sometimes" },
    unemployment_quarterly_sectoral: { display_name: "Unemployment by sector (quarterly, 1957-)", geo_levels: ["national"], n_member_variables: 931, n_observations: 931, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1956-1978", zeros_are_real: "sometimes" },
    urban_rural_population_subnational: { display_name: "Urban / rural population (subnational)", geo_levels: ["national", "province"], n_member_variables: 2, n_observations: 316, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1895-1930", zeros_are_real: "never" },
    urbanization_share: { display_name: "Urbanization share", geo_levels: ["national", "province"], n_member_variables: 7, n_observations: 177, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1895-1982", zeros_are_real: "never" },
    vaccination_subnational: { display_name: "Vaccination programme (juntas de vacuna, vacunados, virus repartido)", geo_levels: ["department", "national", "province"], n_member_variables: 21, n_observations: 2560, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1857-1892", zeros_are_real: "always" },
    vineyards_and_beverages: { display_name: "Vineyards and beverage production (vinos, chichas, aguardientes)", geo_levels: ["province"], n_member_variables: 13, n_observations: 234, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1924-1924", zeros_are_real: "sometimes" },
    ...
    wages_sectoral: { display_name: "Wages by economic sector (real / registered monthly)", geo_levels: ["national", "region"], n_member_variables: 27, n_observations: 423, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos_1995", valid_years_pattern: "1940-2000", zeros_are_real: "never" },
    welfare_institutions: { display_name: "Welfare institutions (hospicios, dispensarias, beneficencia)", geo_levels: ["city", "department", "national"], n_member_variables: 8, n_observations: 613, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1886-1894", zeros_are_real: "always" },
};
