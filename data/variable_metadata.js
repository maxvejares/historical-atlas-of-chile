...
window._variableToFamily = {
    ...
    ruralpop: "urban_rural_population_subnational",
...
window._familyMetadata = {
    age_specific_fertility: { display_name: "Age-specific fertility rates", geo_levels: ["country"], n_member_variables: 27, n_observations: 225, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1960-1970", zeros_are_real: "never" },
    agrarian_labor_indicators: { display_name: "Agrarian labor indicators (inquilinos, enfiteutas, dual-tenure)", geo_levels: ["commune", "department", "municipality"], n_member_variables: 4, n_observations: 1007, per_capita_default: "default_pc", source_type: "external_academic", units: "count", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    agricultural_census_1930_commune: { display_name: "1930 Agricultural Census, commune level (size classes)", geo_levels: ["commune", "comuna", "department"], n_member_variables: 16, n_observations: 7251, per_capita_default: "user_choice", source_type: "census", units: "count", valid_years_pattern: "1930-1930", zeros_are_real: "sometimes" },
    agriculture_province_1924: { display_name: "Agriculture province 1924 (papas, trigo_blanco)", geo_levels: ["provincia"], n_member_variables: 6, n_observations: 372, per_capita_default: "user_choice", source_type: "anuario", units: "physical_quantity", valid_years_pattern: "1924-1924", zeros_are_real: "sometimes" },
    agriculture_province_1935: { display_name: "Agriculture/livestock province 1935", geo_levels: ["departamento", "province", "provincia"], n_member_variables: 29, n_observations: 1013, per_capita_default: "user_choice", source_type: "anuario", units: "physical_quantity", valid_years_pattern: "1855-1935", zeros_are_real: "sometimes" },
    anuario_1875_trailing_year: { display_name: "Anuario 1875 trailing-year columns", geo_levels: ["province"], n_member_variables: 6, n_observations: 354, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    auto_alumnos_h_yyyy: { display_name: "Auto Alumnos H Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    auto_alumnos_m_yyyy: { display_name: "Auto Alumnos M Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    auto_alumnos_total_yyyy: { display_name: "Auto Alumnos Total Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    ...
    auto_escuelas_h_yyyy: { display_name: "Auto Escuelas H Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    auto_escuelas_m_yyyy: { display_name: "Auto Escuelas M Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    auto_escuelas_total_yyyy: { display_name: "Auto Escuelas Total Yyyy", geo_levels: ["province"], n_member_variables: 3, n_observations: 80, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1855-1858", zeros_are_real: "never" },
    auto_gasto_gobierno_yyyy: { display_name: "Auto Gasto Gobierno Yyyy", geo_levels: ["national"], n_member_variables: 3, n_observations: 7, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1868-1868", zeros_are_real: "never" },
    auto_pop_censal_yyyy: { display_name: "Auto Pop Censal Yyyy", geo_levels: ["department", "national", "province"], n_member_variables: 6, n_observations: 1036, per_capita_default: "user_choice", source_type: "compiled", units: "count", valid_years_pattern: "1865-1920", zeros_are_real: "never" },
    ...
    british_foreign_office_fiscal_gbp: { display_name: "British Foreign Office: Chilean fiscal (GBP)", geo_levels: ["national"], n_member_variables: 20, n_observations: 1702, per_capita_default: "user_choice", source_type: "external_academic", units: "currency_gbp", valid_years_pattern: "1833-1914", zeros_are_real: "sometimes" },
    ...
    budget: { display_name: "Annual budget (presupuestos)", geo_levels: ["country", "national"], n_member_variables: 3, n_observations: 101, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1940", zeros_are_real: "never" },
    chilean_fiscal_pesos: { display_name: "Chilean fiscal: customs / tax / revenue in pesos", geo_levels: ["national", "port"], n_member_variables: 20, n_observations: 1959, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1930", zeros_are_real: "sometimes" },
    ...
    court_statistics: { display_name: "Court statistics (causas civiles / criminales)", geo_levels: ["province"], n_member_variables: 6, n_observations: 298, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1899-1899", zeros_are_real: "sometimes" },
    ...
    demographic_indices_1976: { display_name: "Demographic indices (dependency, masculinity, ageing)", geo_levels: ["country", "region"], n_member_variables: 3, n_observations: 45, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1976-1976", zeros_are_real: "never" },
    dlw_commodity_production: { display_name: "Commodity production volumes (national, DLW long series)", geo_levels: ["departamento", "national", "provincia"], n_member_variables: 19, n_observations: 5857, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "physical_quantity", valid_years_pattern: "1860-1995", zeros_are_real: "sometimes" },
    dlw_demographics_capitalized: { display_name: "DLW national demographic series (capitalized)", geo_levels: ["national"], n_member_variables: 8, n_observations: 2839, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "rate", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_exports_categorical_lower: { display_name: "Exports by sector (DLW lowercase, mill_usd / pct)", geo_levels: ["national"], n_member_variables: 8, n_observations: 3648, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_usd", valid_years_pattern: "1844-1995", zeros_are_real: "sometimes" },
    dlw_fiscal_capitalized: { display_name: "DLW fiscal series (capitalized: Trib_, Ing_, G_, Gastos_, Gasto_)", geo_levels: ["national"], n_member_variables: 34, n_observations: 9520, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1810-1995", zeros_are_real: "sometimes" },
    dlw_fiscal_share_series: { display_name: "Diaz-Lüders-Wagner fiscal share series (national)", geo_levels: ["national"], n_member_variables: 13, n_observations: 6573, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "pct", valid_years_pattern: "1810-1995", zeros_are_real: "sometimes" },
    dlw_gdp_series: { display_name: "Diaz-Lüders-Wagner GDP series (national, 1810-1995)", geo_levels: ["national"], n_member_variables: 6, n_observations: 3339, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_imports_categorical_lower: { display_name: "Imports by category (DLW lowercase, mill_usd / pct)", geo_levels: ["national"], n_member_variables: 8, n_observations: 2256, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_usd", valid_years_pattern: "1844-1937", zeros_are_real: "sometimes" },
    dlw_investment_capitalized: { display_name: "DLW investment / capital formation (capitalized)", geo_levels: ["national"], n_member_variables: 12, n_observations: 1344, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1940-1995", zeros_are_real: "sometimes" },
    dlw_labor_capitalized: { display_name: "DLW labor force series (capitalized)", geo_levels: ["national"], n_member_variables: 20, n_observations: 6642, per_capita_default: "default_pc", source_type: "diaz_luders_wagner", units: "count", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_labor_force_national: { display_name: "Diaz-Lüders-Wagner labor force shares (national)", geo_levels: ["national"], n_member_variables: 13, n_observations: 7254, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "pct", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_monetary_capitalized: { display_name: "DLW monetary aggregates and price indices (capitalized)", geo_levels: ["national"], n_member_variables: 36, n_observations: 11520, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "index", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_pib_capitalized: { display_name: "DLW national accounts: PIB nominal/real/sectoral (capitalized)", geo_levels: ["country", "national"], n_member_variables: 25, n_observations: 8872, per_capita_default: "default_raw", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    dlw_trade_series: { display_name: "Diaz-Lüders-Wagner trade series (national, 1810-1995)", geo_levels: ["national"], n_member_variables: 13, n_observations: 7254, per_capita_default: "user_choice", source_type: "diaz_luders_wagner", units: "currency_pesos_1995", valid_years_pattern: "1810-1995", zeros_are_real: "sometimes" },
    economic_activity_provincial: { display_name: "Provincial economic activity panel (1952-1970, holding pen)", geo_levels: ["country", "province"], n_member_variables: 14, n_observations: 1636, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1854-1983", zeros_are_real: "sometimes" },
    economically_active_population: { display_name: "Economically active population (PEA)", geo_levels: ["country", "national"], n_member_variables: 25, n_observations: 472, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1860-1995", zeros_are_real: "never" },
    education_enrollment_matricula: { display_name: "Education enrollment (matrícula, anuario series)", geo_levels: ["national", "province"], n_member_variables: 13, n_observations: 2954, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1852-1995", zeros_are_real: "never" },
    education_matricula_extended: { display_name: "Education matrícula and asistencia (1891-1935)", geo_levels: ["department", "national", "province"], n_member_variables: 8, n_observations: 308, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1891-1990", zeros_are_real: "never" },
    ...
    electoral_participation_1935_1970_national: { display_name: "Electoral participation national 1935-1970 (Inscritas, Votantes, Abstención)", geo_levels: ["national"], n_member_variables: 5, n_observations: 93, per_capita_default: "default_raw", source_type: "compiled", units: "count", valid_years_pattern: "1930-1970", zeros_are_real: "sometimes" },
    ...
    electoral_subnational: { display_name: "Electoral panel (calificados, inscriptos, sufragantes)", geo_levels: ["department", "national", "province"], n_member_variables: 30, n_observations: 4506, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1862-1935", zeros_are_real: "never" },
    employment_quarterly_sectoral: { display_name: "Employment by sector (quarterly, 1957-)", geo_levels: ["country", "national"], n_member_variables: 537, n_observations: 770, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1941-1978", zeros_are_real: "never" },
    ethnicity_indigenous: { display_name: "Ethnicity / indigenous population (Mapuche, Mestizo, Indios)", geo_levels: ["national"], n_member_variables: 3, n_observations: 10, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1811-1928", zeros_are_real: "sometimes" },
    ...
    expenditure_per_capita: { display_name: "Expenditure per capita (derived)", geo_levels: ["national"], n_member_variables: 1, n_observations: 558, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    export_duties: { display_name: "Export duties by commodity (copper, salitre, gold, silver, wheat)", geo_levels: ["national"], n_member_variables: 11, n_observations: 45, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1834-1929", zeros_are_real: "sometimes" },
    fiscal_categorical_lower: { display_name: "Fiscal categorical lowercase (fiscal_derechos_, fiscal_gasto_, fiscal_rentas_)", geo_levels: ["national", "province"], n_member_variables: 19, n_observations: 148, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1900-1914", zeros_are_real: "sometimes" },
    fiscal_expenditure_categorical: { display_name: "Fiscal expenditure (categorical)", geo_levels: ["country", "department", "municipality", "national", "province"], n_member_variables: 86, n_observations: 5250, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1817-1988", zeros_are_real: "sometimes" },
    fiscal_revenue_categorical: { display_name: "Fiscal revenue (categorical)", geo_levels: ["department", "national", "province"], n_member_variables: 27, n_observations: 1242, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1810-1995", zeros_are_real: "sometimes" },
    geo_metadata: { display_name: "Geographic metadata (codes, coordinates)", geo_levels: ["commune", "department", "municipality", "province"], n_member_variables: 5, n_observations: 6590, per_capita_default: "not_applicable", source_type: "compiled", units: "categorical", valid_years_pattern: "1845-1970", zeros_are_real: "always" },
    geo_metadata_extended: { display_name: "Geographic metadata extended (lat, lon, capital, surface)", geo_levels: ["commune", "comuna", "department", "national", "province"], n_member_variables: 7, n_observations: 906, per_capita_default: "not_applicable", source_type: "compiled", units: "categorical", valid_years_pattern: "1854-1952", zeros_are_real: "always" },
    government_accounts: { display_name: "Government accounts (cuenta_gobierno_*)", geo_levels: ["country"], n_member_variables: 182, n_observations: 1560, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1960-1970", zeros_are_real: "sometimes" },
    hospital_statistics: { display_name: "Hospital statistics (admissions, beds, deaths, expenses, subsidies)", geo_levels: ["city", "department", "national", "province", "provincia"], n_member_variables: 39, n_observations: 2815, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1840-1940", zeros_are_real: "sometimes" },
    household_consumption_indicators: { display_name: "Household consumption indicators (calidad_vida_*, equip_hogar_*, pct_hogares_*)", geo_levels: ["country", "national"], n_member_variables: 86, n_observations: 167, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1970-1982", zeros_are_real: "never" },
    household_dwellings: { display_name: "Household dwellings panel (cities, conventillos, hacinamiento)", geo_levels: ["national"], n_member_variables: 12, n_observations: 26, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1860-1907", zeros_are_real: "sometimes" },
    housing_surface: { display_name: "Building and housing surface (1952-1999)", geo_levels: ["country"], n_member_variables: 12, n_observations: 640, per_capita_default: "default_pc", source_type: "compiled", units: "physical_quantity", valid_years_pattern: "1952-2000", zeros_are_real: "sometimes" },
    juvenile_justice: { display_name: "Juvenile justice (Menores Bajo Control)", geo_levels: ["national"], n_member_variables: 1, n_observations: 20, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1821-1983", zeros_are_real: "never" },
    ...
    labor_force_participation_extended: { display_name: "Labor force participation extended (ocupacion, pct_poblacion_12plus, etc.)", geo_levels: ["country", "national"], n_member_variables: 42, n_observations: 164, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1853-1976", zeros_are_real: "sometimes" },
    ...
    landholding_avaluo: { display_name: "Landholding: avaluo and Rol", geo_levels: ["constituency", "department"], n_member_variables: 25, n_observations: 5980, per_capita_default: "user_choice", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1830-1970", zeros_are_real: "never" },
    landholding_extended: { display_name: "Landholding extended (sna_ totals, 1875 landowners, dept aggregates)", geo_levels: ["department", "province"], n_member_variables: 16, n_observations: 1133, per_capita_default: "user_choice", source_type: "external_academic", units: "count", valid_years_pattern: "1865-1885", zeros_are_real: "sometimes" },
    landholding_manorial: { display_name: "Landholding: manorial classification", geo_levels: ["department"], n_member_variables: 3, n_observations: 789, per_capita_default: "not_applicable", source_type: "external_academic", units: "boolean", valid_years_pattern: "1865-1970", zeros_are_real: "always" },
    ...
    legislators_province_1920: { display_name: "Legislators by province 1920 (senadores, diputados)", geo_levels: ["province"], n_member_variables: 2, n_observations: 138, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1920-1920", zeros_are_real: "sometimes" },
    life_expectancy_provincial: { display_name: "Life expectancy provincial (esperanza_vida_*)", geo_levels: ["national", "province", "region"], n_member_variables: 12, n_observations: 276, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1854-1972", zeros_are_real: "never" },
    literacy_subnational: { display_name: "Literacy (subnational, by census year)", geo_levels: ["country", "department", "national", "province"], n_member_variables: 27, n_observations: 677, per_capita_default: "default_raw", source_type: "census", units: "rate", valid_years_pattern: "1854-1970", zeros_are_real: "never" },
    macroeconomic_indicators: { display_name: "Macroeconomic indicators (PIB growth, employment, inflation, savings)", geo_levels: ["country"], n_member_variables: 14, n_observations: 50, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1989-1990", zeros_are_real: "sometimes" },
    malnutrition_indicators: { display_name: "Malnutrition indicators (Desnutrición *, national 1975-1983)", geo_levels: ["national"], n_member_variables: 4, n_observations: 60, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1975-1983", zeros_are_real: "never" },
    marital_status_subnational: { display_name: "Marital status (casados, solteros, viudos, convivientes, etc.)", geo_levels: ["national", "province"], n_member_variables: 13, n_observations: 234, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1854-1952", zeros_are_real: "sometimes" },
    marriages_age_cohort: { display_name: "Marriages by age cohort", geo_levels: ["country", "national", "province"], n_member_variables: 18, n_observations: 855, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1858-1973", zeros_are_real: "sometimes" },
    migration_internal: { display_name: "Migration (internal / regional, net rates and shares)", geo_levels: ["country", "province", "region"], n_member_variables: 9, n_observations: 303, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1845-1982", zeros_are_real: "sometimes" },
    military_force_count: { display_name: "Military force counts (ejercito, marina, guardia)", geo_levels: ["national"], n_member_variables: 51, n_observations: 387, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1833-1922", zeros_are_real: "sometimes" },
    ...
    mining_production_pesos_oro: { display_name: "Mining production (pesos oro de 18 peniques, 1918-1923)", geo_levels: ["nacional"], n_member_variables: 4, n_observations: 66, per_capita_default: "user_choice", source_type: "anuario", units: "currency_pesos_oro_18d", valid_years_pattern: "1918-1923", zeros_are_real: "sometimes" },
    ministry_budget_1845_1878: { display_name: "Sinopsis ministry budget panel 1845-1878 (interior, hacienda, etc.)", geo_levels: ["national", "province"], n_member_variables: 24, n_observations: 2125, per_capita_default: "user_choice", source_type: "sinopsis", units: "currency_pesos", valid_years_pattern: "1827-1895", zeros_are_real: "sometimes" },
    monetary_minting: { display_name: "Mint receipts and monetary aggregates", geo_levels: ["national"], n_member_variables: 2, n_observations: 196, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1894", zeros_are_real: "sometimes" },
    mortality_categorical: { display_name: "Mortality by cause / category", geo_levels: ["country", "national", "province"], n_member_variables: 22, n_observations: 172, per_capita_default: "default_raw", source_type: "anuario", units: "rate", valid_years_pattern: "1849-1975", zeros_are_real: "sometimes" },
    mortality_natality_long_series: { display_name: "Mortality / natality long series (lowercase)", geo_levels: ["country", "national", "province"], n_member_variables: 95, n_observations: 5104, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1849-1983", zeros_are_real: "never" },
    municipal_finance: { display_name: "Municipal finance (revenue, expenditure, share)", geo_levels: ["commune", "department", "municipality", "national", "province"], n_member_variables: 38, n_observations: 4244, per_capita_default: "user_choice", source_type: "sinopsis", units: "currency_pesos", valid_years_pattern: "1873-1935", zeros_are_real: "sometimes" },
    natality_categorical: { display_name: "Natality / birth rate categorical", geo_levels: ["national"], n_member_variables: 1, n_observations: 444, per_capita_default: "default_raw", source_type: "anuario", units: "rate", valid_years_pattern: "1848-1995", zeros_are_real: "never" },
    ...
    occupations_canonical_subnational: { display_name: "Census occupations (canonical, subnational)", geo_levels: ["department", "province"], n_member_variables: 7, n_observations: 8715, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1862-1920", zeros_are_real: "never" },
    occupations_profesion_subnational: { display_name: "Census detailed occupations (profesion_*)", geo_levels: ["national", "province"], n_member_variables: 1883, n_observations: 10460, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1875-1875", zeros_are_real: "never" },
    occupations_year_prefix_19c: { display_name: "Occupations panel year-prefix 19c (1862_*, 1878_*, etc.)", geo_levels: ["province"], n_member_variables: 76, n_observations: 1436, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "nan", zeros_are_real: "sometimes" },
    police_subnational: { display_name: "Police force subnational (n_police_force, police_budget, police20)", geo_levels: ["commune", "department"], n_member_variables: 3, n_observations: 206, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1895-1920", zeros_are_real: "sometimes" },
    population_density: { display_name: "Population density (per km2)", geo_levels: ["national"], n_member_variables: 1, n_observations: 3, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1831-1854", zeros_are_real: "never" },
    population_growth: { display_name: "Population growth", geo_levels: ["national"], n_member_variables: 2, n_observations: 888, per_capita_default: "default_raw", source_type: "compiled", units: "rate", valid_years_pattern: "1848-1995", zeros_are_real: "sometimes" },
    population_subset_demographic: { display_name: "Population subsets (age, sex, ethnicity)", geo_levels: ["country", "national"], n_member_variables: 34, n_observations: 186, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1865-1992", zeros_are_real: "never" },
    port_shipping_volume: { display_name: "Port shipping volume (tonnage, vessels, maritime entries/exits)", geo_levels: ["national", "port"], n_member_variables: 6, n_observations: 686, per_capita_default: "user_choice", source_type: "memoria", units: "count", valid_years_pattern: "1874-1914", zeros_are_real: "sometimes" },
    ...
    postal_volume: { display_name: "Postal volume (cartas, impresos, oficios)", geo_levels: ["national", "province"], n_member_variables: 63, n_observations: 380, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1831-1935", zeros_are_real: "sometimes" },
    prisons: { display_name: "Prison / corrections (reos, presidios, correccionales)", geo_levels: ["city", "national", "province", "provincia"], n_member_variables: 98, n_observations: 1872, per_capita_default: "default_pc", source_type: "memoria", units: "count", valid_years_pattern: "1869-1935", zeros_are_real: "sometimes" },
    ...
    provincial_gdp_share_1966_1970: { display_name: "Provincial GDP shares and growth (1966-1970)", geo_levels: ["province", "region"], n_member_variables: 4, n_observations: 326, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1966-1970", zeros_are_real: "sometimes" },
    public_debt: { display_name: "Public debt (internal, external, total)", geo_levels: ["country", "national"], n_member_variables: 84, n_observations: 3115, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1822-1995", zeros_are_real: "sometimes" },
    ...
    real_income_sectoral: { display_name: "Real income by sector", geo_levels: ["country"], n_member_variables: 11, n_observations: 308, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos_1995", valid_years_pattern: "1940-1983", zeros_are_real: "never" },
    religion_subnational: { display_name: "Religion subnational (Catholic, Protestant, Evangelical, Jewish, etc.)", geo_levels: ["country", "national", "province"], n_member_variables: 17, n_observations: 165, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1920-1970", zeros_are_real: "sometimes" },
    rural_urban_share_long_series: { display_name: "Rural/urban population share long series", geo_levels: ["country", "macro_region", "national", "province"], n_member_variables: 13, n_observations: 2264, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1835-2000", zeros_are_real: "never" },
    ...
    schools_count_subnational: { display_name: "Schools count (subnational)", geo_levels: ["department"], n_member_variables: 4, n_observations: 81, per_capita_default: "user_choice", source_type: "census", units: "count", valid_years_pattern: "1875-1920", zeros_are_real: "sometimes" },
    schools_subnational_monograph: { display_name: "Schools by department (count, enrollment, attendance, municipal and government subsidy)", geo_levels: ["department", "province"], n_member_variables: 7, n_observations: 70, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1870-1870", zeros_are_real: "never" },
    secondary_education_panel: { display_name: "Secondary education panel (students, schools by funder type and sex)", geo_levels: ["country", "national"], n_member_variables: 19, n_observations: 38, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1822-1900", zeros_are_real: "never" },
    social_spending: { display_name: "Government social spending (gasto_social_*, gasto_real, etc.)", geo_levels: ["country", "national", "province"], n_member_variables: 17, n_observations: 320, per_capita_default: "default_pc", source_type: "compiled", units: "currency_pesos", valid_years_pattern: "1842-2000", zeros_are_real: "sometimes" },
    state_capacity_1899_dept: { display_name: "Dept state capacity 1899 (school, justice, pworks, civilreg, etc.)", geo_levels: ["commune"], n_member_variables: 8, n_observations: 1330, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1899-1935", zeros_are_real: "sometimes" },
    ...
    state_owned_enterprises: { display_name: "State-owned enterprise share of sector", geo_levels: ["country"], n_member_variables: 7, n_observations: 26, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1965-1972", zeros_are_real: "sometimes" },
    subnational_population_lowercase: { display_name: "Subnational population (lowercase Spanish: poblacion_*, hombres, mujeres)", geo_levels: ["country", "department", "national", "nationality", "province", "provincia", "religion"], n_member_variables: 108, n_observations: 4362, per_capita_default: "default_pc", source_type: "census", units: "count", valid_years_pattern: "1822-2000", zeros_are_real: "never" },
    subnational_population_titled: { display_name: "Subnational population, Spanish title-case columns", geo_levels: ["department", "national", "province"], n_member_variables: 50, n_observations: 3971, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1811-2000", zeros_are_real: "never" },
    tariff_rates: { display_name: "Tariff rates", geo_levels: ["national"], n_member_variables: 2, n_observations: 566, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1833-1995", zeros_are_real: "sometimes" },
    ...
    total_population_subnational: { display_name: "Total population (subnational)", geo_levels: ["commune", "country", "department", "municipality", "national", "province", "provincia", "religion"], n_member_variables: 10, n_observations: 7233, per_capita_default: "not_applicable", source_type: "census", units: "count", valid_years_pattern: "1810-1995", zeros_are_real: "never" },
    trade_exports: { display_name: "Exports (trade)", geo_levels: ["national"], n_member_variables: 8, n_observations: 400, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1844-1924", zeros_are_real: "sometimes" },
    trade_imports: { display_name: "Imports (trade)", geo_levels: ["country", "national"], n_member_variables: 26, n_observations: 3742, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1810-1995", zeros_are_real: "sometimes" },
    trade_total_categorical: { display_name: "Total trade and trade categories", geo_levels: ["national", "port"], n_member_variables: 24, n_observations: 742, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1844-1914", zeros_are_real: "sometimes" },
    transport_1935_province: { display_name: "Transport 1935 province (vehicles, road km)", geo_levels: ["national", "province"], n_member_variables: 20, n_observations: 2740, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1860-1995", zeros_are_real: "sometimes" },
    unemployment_quarterly_sectoral: { display_name: "Unemployment by sector (quarterly, 1957-)", geo_levels: ["country"], n_member_variables: 931, n_observations: 1181, per_capita_default: "default_pc", source_type: "compiled", units: "count", valid_years_pattern: "1956-1978", zeros_are_real: "sometimes" },
    urban_rural_population_subnational: { display_name: "Urban / rural population (subnational)", geo_levels: ["commune", "department", "national", "province"], n_member_variables: 4, n_observations: 2182, per_capita_default: "default_raw", source_type: "census", units: "count", valid_years_pattern: "1865-1992", zeros_are_real: "never" },
    urbanization_share: { display_name: "Urbanization share", geo_levels: ["country", "municipality", "national", "province"], n_member_variables: 8, n_observations: 673, per_capita_default: "default_raw", source_type: "compiled", units: "pct", valid_years_pattern: "1895-1982", zeros_are_real: "never" },
    ...
    vital_statistics_subnational: { display_name: "Vital statistics (registry)", geo_levels: ["department", "national"], n_member_variables: 12, n_observations: 806, per_capita_default: "default_pc", source_type: "anuario", units: "count", valid_years_pattern: "1869-1920", zeros_are_real: "never" },
    wages_official: { display_name: "Official salaries (sueldos)", geo_levels: ["national"], n_member_variables: 2, n_observations: 94, per_capita_default: "user_choice", source_type: "memoria", units: "currency_pesos", valid_years_pattern: "1833-1853", zeros_are_real: "never" },
    wages_sectoral: { display_name: "Wages by economic sector (real / registered monthly)", geo_levels: ["country", "region"], n_member_variables: 27, n_observations: 844, per_capita_default: "default_raw", source_type: "compiled", units: "currency_pesos_1995", valid_years_pattern: "1940-2000", zeros_are_real: "never" },
};
